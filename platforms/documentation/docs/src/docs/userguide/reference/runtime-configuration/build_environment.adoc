...
<div style="text-align: right;">
  <a href="https://github.com/gradle/gradle/tree/master/platforms/documentation/docs/src/snippets/reference/runtime-configuration/configureTaskUsingProjectProperty">
