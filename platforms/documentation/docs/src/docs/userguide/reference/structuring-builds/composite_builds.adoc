...
====
include::sample[dir="snippets/build-organization/composite-builds-basic/kotlin",files="settings.gradle.kts[tags=inc]"]
include::sample[dir="snippets/build-organization/composite-builds-basic/groovy",files="settings.gradle[tags=inc]"]
====
...
[source,text]
----
include::{snippetsPath}/build-organization/composite-builds-basic/tests/inheritance.out[]
----
...
====
include::sample[dir="snippets/build-organization/composite-builds-basic/kotlin/my-app",files="settings.gradle.kts[tags=mag]"]
include::sample[dir="snippets/build-organization/composite-builds-basic/groovy/my-app",files="settings.gradle[tags=mag]"]
====

Then the plugin is used as follows:

====
include::sample[dir="snippets/build-organization/composite-builds-basic/kotlin",files="my-app/app/build.gradle.kts[tags=plugin_dependencies]"]
include::sample[dir="snippets/build-organization/composite-builds-basic/groovy",files="my-app/app/build.gradle[tags=plugin_dependencies]"]
====
...
====
include::sample[dir="snippets/build-organization/composite-builds-declared-substitution/kotlin",files="anonymous-library/build.gradle.kts[]"]
include::sample[dir="snippets/build-organization/composite-builds-declared-substitution/groovy",files="anonymous-library/build.gradle[]"]
====
