...
/**
 * A {@link ProjectFeaturePluginClassBuilder} that injects an unknown service class into the services interface, which should
 * cause the feature binding to fail.
 */
class ProjectFeaturePluginThatInjectsUnknownServiceClassBuilder extends ProjectFeaturePluginThatUsesUnsafeServicesClassBuilder {
