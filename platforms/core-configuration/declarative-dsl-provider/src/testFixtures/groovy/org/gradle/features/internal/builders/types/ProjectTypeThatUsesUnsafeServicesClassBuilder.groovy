...
/**
 * A {@link ProjectTypePluginClassBuilder} for generating a project type plugin class that uses an unsafe service (Project} in its services interface.
 */
class ProjectTypeThatUsesUnsafeServicesClassBuilder extends ProjectTypePluginClassBuilder {
