...
/**
 * A {@link ProjectTypePluginClassBuilder} for generating a project type plugin class that uses an unknown service in its services interface.
 */
class ProjectTypeThatUsesUnknownServicesClassBuilder extends ProjectTypePluginClassBuilder {
